...
- Registered source IDs and any term/version limitation
...
Generate one set of 3-5 questions after each exam topic. Do not add a separate readiness set before it:
...
- If `exam-review/school-question-patterns.md` contains enough evidence, ask whether to use original AI questions, school-style imitation, or a mixed set. If evidence only comes from ordinary tutorial sheets, label school-style imitation as provisional.
