...
6. One nontrivial post-point exercise set
...
The profile controls explanation order, not content coverage. Continue to follow the validated blueprint, four hard gates, one-set exercise rule, source rules, language contracts, and mode-specific assessment rules.
